...
class AdvancedDataSplitter:
    ...
    def _create_random_split(self, name: str, smiles: List[str], 
        ...
        try:
            ...
            if min_bin_count >= 2:
                ...
                stratified = True
                self.logger.info("  ✓ Stratification successful")
            else:
                # Simple random split
                train_idx, test_idx = train_test_split(
                    indices, 
            ...
            self.logger.info(f"  ✓ Random split: {len(train_idx)} train, {len(test_idx)} test")
    ...
    def _create_scaffold_split(self, name: str, smiles: List[str], 
        ...
        try:
            ...
            self.logger.info(f"  ✓ Scaffold split: {len(train_idx)} train, {len(test_idx)} test")
    ...
    def _create_chemical_space_coverage_split(self, name: str, smiles: List[str], 
        ...
        try:
            ...
            self.logger.info(f"  ✓ Chemical space coverage split: {len(train_idx)} train, {len(test_idx)} test")
    ...
    def _create_cluster_split(self, name: str, smiles: List[str], 
        ...
        try:
            ...
            self.logger.info(f"  ✓ Cluster split: {len(train_idx)} train, {len(test_idx)} test")
    ...
    def _create_physchem_split(self, name: str, smiles: List[str], 
        ...
        try:
            ...
            self.logger.info(f"  ✓ Physicochemical split: {len(train_idx)} train, {len(test_idx)} test")
    ...
    def _create_activity_cliff_split(self, name: str, smiles: List[str], 
        ...
        try:
            ...
            self.logger.info(f"  ✓ Activity cliff split: {len(train_idx)} train, {len(test_idx)} test")
    ...
    def _create_solubility_aware_split(self, name: str, smiles: List[str], 
        ...
        try:
            ...
            self.logger.info(f"  ✓ Solubility-aware split: {len(train_idx)} train, {len(test_idx)} test")
    ...
    def _create_time_series_split(self, name: str, smiles: List[str], 
        ...
        try:
            ...
            self.logger.info(f"  ✓ Time series split: {len(train_idx)} train, {len(test_idx)} test")
    ...
    def _create_ensemble_split(self, name: str, smiles: List[str], 
        ...
        try:
            ...
            self.logger.info(f"  ✓ Ensemble split: {len(train_idx)} train, {len(test_idx)} test")
    ...
    def _create_test_only_split(self, name: str, smiles: List[str], 
        ...
        try:
            ...
            self.logger.info(f"  ✓ Test-only split: 0 train, {len(test_idx)} test")
    ...
    def _create_simple_cluster_split(self, name: str, smiles: List[str], 
        ...
        try:
            ...
            self.logger.info(f"  ✓ Simple cluster split: {len(train_idx)} train, {len(test_idx)} test")
    ...
    def _validate_all_splits(self, splits: Dict, smiles: List[str], 
        ...
        self.logger.info("✓ All splits validated successfully")
    ...
    def _save_split_report(self, name: str):
        ...
        self.logger.info(f"✓ Saved comprehensive report: {json_path.name} and {excel_path.name}")
    ...
    def _print_split_summary(self, splits: Dict):
        ...
        for split_name, split_data in splits.items():
            if split_data:
                ...
                self.logger.info(f"\n{split_name.upper()}:")
                self.logger.info(f"  ✓ Train: {train_size}, Test: {test_size} (Test ratio: {test_ratio:.2%})")
...
if __name__ == "__main__":
    ...
    for i, (method, abbrev) in enumerate(SPLIT_ABBREVIATIONS.items(), 1):
        status = "✓" if method in splits and splits[method] is not None else "✗"
